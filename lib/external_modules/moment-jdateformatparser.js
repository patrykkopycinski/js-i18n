...
(function (root, cb) {
   ...
   * @returns {String}
   */
  var translateFormat = function translateFormat(formatString, mapping) {
   ...
   * @private
   */
  var _appendMappedString = function _appendMappedString(formatString, mapping, beginIndex, currentIndex, resultString) {
    var tempString;
